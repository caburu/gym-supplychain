...
class TestSupplyChainEnv:
    ...
    def test_simpleenv(self):
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(3,1,50)]
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(3,1,50), (4,2,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(4,2,10)]
        assert env.nodes[2].shipments_by_prod[0] == [(4,2,5)]
        assert env.nodes[3].shipments_by_prod[0] == [(4,2,10)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(4,2,50), (5,3,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(4,2,10), (5,3,50)]
        assert env.nodes[2].shipments_by_prod[0] == [(4,2, 5)]
        assert env.nodes[3].shipments_by_prod[0] == [(4,2,10)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(5,3,50), (6,4,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(5,3,50), (6,4,50)]
        assert env.nodes[2].shipments_by_prod[0] == [(6,4, 5)]
        assert env.nodes[3].shipments_by_prod[0] == [(6,4, 5)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(6,4,50), (7,5,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(6,4,50), (7,5,50)]
        assert env.nodes[2].shipments_by_prod[0] == [(6,4, 5), (7,5,25)]
        assert env.nodes[3].shipments_by_prod[0] == [(6,4, 5)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        assert env.nodes[-1].stock == max(0, 10+10 - sum(env.customer_demands[:env.time_step+1]))
    ...
    def test_stocleadtimes_simpleenv(self):
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(4,1,50)]
        for node in env.nodes[1:]:
            assert len(node.shipments_by_prod[0]) == 0
        for node in env.nodes[:-1]:
            assert node.stock == 10
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(4,1,50), (5,2,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(4,2,10)]
        assert env.nodes[2].shipments_by_prod[0] == [(3,2, 5)]
        assert env.nodes[3].shipments_by_prod[0] == [(4,2,10)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        assert env.nodes[-1].stock == max(0, 10 - sum(env.customer_demands[:env.time_step+1]))
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(4,1,50), (5,2,50), (5,3,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(4,2,10)]
        assert env.nodes[2].shipments_by_prod[0] == []
        assert env.nodes[3].shipments_by_prod[0] == [(4,2,10), (6,3,5)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        assert env.nodes[-1].stock == max(0, 10 - sum(env.customer_demands[:env.time_step+1]))
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(5,2,50), (5,3,50), (6,4,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(6,4,50)]
        assert env.nodes[2].shipments_by_prod[0] == [(6,4, 5)]
        assert env.nodes[3].shipments_by_prod[0] == [(6,3, 5)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
        assert env.nodes[-1].stock == max(0, 10+10 - sum(env.customer_demands[:env.time_step+1]))
        ...
        assert env.nodes[0].shipments_by_prod[0] == [(6,4,50), (6,5,50)]
        assert env.nodes[1].shipments_by_prod[0] == [(6,4,50), (6,5,100)]
        assert env.nodes[2].shipments_by_prod[0] == [(6,4, 5),]
        assert env.nodes[3].shipments_by_prod[0] == [(6,3, 5)]
        for node in env.nodes[:-1]:
            assert node.stock == 0
